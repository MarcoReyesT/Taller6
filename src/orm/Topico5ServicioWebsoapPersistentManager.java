...
public class Topico5ServicioWebsoapPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Topico5ServicioWebsoap";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Topico5ServicioWebsoapPersistentManager();
		}
